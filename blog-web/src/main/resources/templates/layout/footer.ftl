            ...
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12 col-md-12 col-lg-12">
                        ...
                        <p>托管于<a href="https://www.aliyun.com/minisite/goods?userCode=ze3m6t91" target="_blank" title="阿里云-为了无法计算的价值" data-toggle="tooltip" data-placement="bottom" rel="external nofollow">阿里云</a> <#if config.recordNumber!> · <a href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank" title="查看备案信息" data-toggle="tooltip" data-placement="bottom" rel="external nofollow">${config.recordNumber}</a></#if></p>
                        <p>本站由<a href="https://www.upyun.com/?utm_source=lianmeng&utm_medium=referral"><img style="max-height: 30px" src="/img/upyunlogo.png"/>提供cdn加速/云存储服务</a></p>
                    </div>
